...
public class PolicySttServiceImpl implements PolicySttService {
    ...
    @Transactional(readOnly = true, value = "SAMPLETransactionManager")
    @Override
    public Page<PolicyStt> findHistory(String systemClause, String query, Pageable pageable) {
    ...
    @Transactional(readOnly = true, value = "SAMPLETransactionManager")
    @Override
    public Page<PolicyStt> findHistory(List<PeriodClause> periodClauses, String query, Pageable pageable) {
        LOGGER.debug("Finding history data for PolicyStt");
